...
const socket = io("https://tmdt.vercel.app");
...
function Checkout(props) {
  ...
  //Hàm để gọi API và render số sản phẩm
  useEffect(() => {
  ...
  //Hàm để tính tổng tiền carts
  function getTotal(carts) {
    let sub_total = 0;

    const sum_total = carts.map((value) => {
      return (sub_total +=
        parseInt(value.productPrice) * parseInt(value.count));
    });
                          ...
                          <div key={value._id}>
                            <li className="d-flex align-items-center justify-content-between">
                              ...
                              <span className="text-muted small">
                                {convertMoney(value.productPrice)} VND x{" "}
                                {value.count}
                              </span>
                            </li>
